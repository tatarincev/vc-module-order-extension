...
namespace VirtoCommerce.OrderExtModule.Web.JsonConverters {
    public class PolymorphicOperationJsonConverterExt : JsonConverter {
        ...
        public PolymorphicOperationJsonConverterExt(IPaymentMethodsService paymentMethodsService, IShippingMethodsService shippingMethodsService) {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer) {
            ...
            } else if (typeof(ShipmentExtension).IsAssignableFrom(objectType)) {
                retVal = AbstractTypeFactory<Shipment>.TryCreateInstance();
